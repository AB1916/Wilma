#include p18f87k22.inc
    ...
    global  LCD_Setup, LCD_Write_Message, LCD_Write_Hex, LCD_delay_ms,LCD_Send_Byte_I,LCD_Send_Byte_D,LCD_delay_q
...
lcdlp2	movlw	.250	    ; 1 ms delay
	...
	bra	lcdlp2
	return
LCD_delay_q		    ; delay given in ms in W
	movwf	LCD_cnt_ms
lcdlp8	movlw	.100	    ; 1 ms delay
	call	LCD_delay_x4us	
	decfsz	LCD_cnt_ms
	bra	lcdlp8
	return
